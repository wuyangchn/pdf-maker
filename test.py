...
stream = pt.Obj(type="", index="8", text=[pt.Text(
    font_name="F1", font="arial", size=24, x=100, y=100, text="This is the second page")])
page = pt.Obj(type="page", index="7", parent="2", contents="8", mediabox=[0, 0, 1000, 300],
              resources=pt.Resources(font="F1", font_index=a.get_obj(type="font")[0].index()))
...
line = a.line(page=0, start=[600, 200], end=[400, 400], width=5, color="red")

a.rect(page=0, left_bottom=[200, 200], width=400, height=400, line_width=1, color="blue", z_index=9)

for i in range(50):
    a.scatter(page=0, x=200+i*10, y=400 + i * 2, size=4)
    a.scatter(page=0, x=500-i*10, y=400 + i * 2, size=4, type="rectangle")
